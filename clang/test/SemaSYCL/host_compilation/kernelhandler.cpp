...
// CHECK-H: extern "C" void _ZTS5Test1subhandler( const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs);
...
// CHECK-H-NEXT:     _ZTS5Test1subhandler(MArgs);
// CHECK-H-NEXT:   }
...
//CHECK-HC: extern "C" void _ZTS5Test1(void *, void *, void *)
//CHECK-HC:void _ZTS5Test1subhandler(const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs) {
//CHECK-HC-NEXT:  void* ptr1 = MArgs[1].getPtr();
//CHECK-HC-NEXT:  void* ptr2 = MArgs[2].getPtr();
//CHECK-HC-NEXT:  void* ptr3 = MArgs[3].getPtr();
//CHECK-HC-NEXT:  _ZTS5Test1(ptr1, ptr2, ptr3);
//CHECK-HC-NEXT:};


// CHECK-NO-DAE-H: extern "C" void _ZTS5Test1subhandler( const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs);
...
// CHECK-NO-DAE-H-NEXT:     _ZTS5Test1subhandler(MArgs);
// CHECK-NO-DAE-H-NEXT:   }


//CHECK-NO-DAE-HC: #pragma once
//CHECK-NO-DAE-HC-NEXT: #include <sycl/detail/host_compilation.hpp>
//CHECK-NO-DAE-HC: extern "C" void _ZTS5Test1(void *, void *, void *, void *);
//CHECK-NO-DAE-HC:void _ZTS5Test1subhandler(const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs) {
...
//CHECK-NO-DAE-HC-NEXT:  _ZTS5Test1(ptr0, ptr1, ptr2, ptr3);

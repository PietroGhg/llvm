...
// CHECK:extern "C" void _Z6init_aIiEsubhandler(const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs, _hc_state *state) {
...
// CHECK:extern "C" void _Z6init_aIjEsubhandler(const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs, _hc_state *state) {
// CHECK-NEXT:  void* arg0 = MArgs[0].getPtr();
// CHECK-NEXT:  void* arg3 = MArgs[3].getPtr();
...
// CHECK:extern "C" void _Z6init_aIfEsubhandler(const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs, _hc_state *state) {
// CHECK-NEXT:  void* arg0 = MArgs[0].getPtr();
// CHECK-NEXT:  void* arg3 = MArgs[3].getPtr();
...
// CHECK:extern "C" void _Z6init_aIdEsubhandler(const std::vector<sycl::detail::HostCompilationArgDesc>& MArgs, _hc_state *state) {
// CHECK-NEXT:  void* arg0 = MArgs[0].getPtr();
// CHECK-NEXT:  void* arg3 = MArgs[3].getPtr();

...
// CHECK: call{{.*}}_hc_get_global_id(i64 0, %struct._hc_state* %2)

// CHECK: @_Z5Test2(i32 addrspace(1)* %0, %"class.sycl::_V1::id"* %1, %struct._hc_state* %2)
// CHECK: call{{.*}}_hc_get_global_id(i64 1, %struct._hc_state* %2)

// CHECK: @_Z5Test3(i32 addrspace(1)* %0, %"class.sycl::_V1::id"* %1, %struct._hc_state* %2)
// CHECK: call{{.*}}_hc_get_global_id(i64 2, %struct._hc_state* %2)
